function navibar() {
  var deshboard = document.getElementById("deshboardData");
  let dd = `
                    ...
                    <div class="py-4 text-gray-400 space-y-1">
                        ...
                        <div class="block" x-data="{open: false}">
                            ...
                            <div x-show="open" class="text-sm border-l-2 border-gray-800 mx-6 my-2.5 px-2.5 flex flex-col gap-y-1">
                                <a href="/list" class="block py-2 px-4  text-decoration-none hover:bg-gray-800 hover:text-white rounded text-light">
                                    Client List
                                </a>
                                <a href="/addclient" class="block py-2  text-decoration-none px-4 hover:bg-gray-800 hover:text-white rounded text-light">
                                    Add Client
                                </a>
                        ...
                        <div class="block" x-data="{open: false}">
                            ...
                            <div x-show="open" class="text-sm border-l-2 border-gray-800 mx-6 my-2.5 px-2.5 flex flex-col gap-y-1">
                                <a href="/additemmaster" class="block py-2 px-4  text-decoration-none text-light hover:bg-gray-800 hover:text-white rounded">
                                    Item  list
                                </a>
                                <a href="/itemMaster" class="block py-2 px-4  text-decoration-none text-light hover:bg-gray-800 hover:text-white rounded">
                                    Add Item 
                                </a>
                        ...
                        <div class="block" x-data="{open: false}">
                            ...
                            <div x-show="open" class="text-sm border-l-2 border-gray-800 mx-6 my-2.5 px-2.5 flex flex-col gap-y-1">
                                <a href="/billingproductlist" class="block py-2 px-4  text-decoration-none text-light hover:bg-gray-800 hover:text-white rounded">
                                    Order  List
                                </a>
                                <a href="/addbillingproduct" class="block py-2 px-4  text-decoration-none text-light hover:bg-gray-800 hover:text-white rounded">
                                    Add Order
                                </a>
                        ...
                        <div class="block" x-data="{open: false}">
                            ...
                            <div x-show="open" class="text-sm border-l-2 border-gray-800 mx-6 my-2.5 px-2.5 flex flex-col gap-y-1">
                                <a href="/combolist" class="block py-2 px-4  text-decoration-none text-light hover:bg-gray-800 hover:text-white rounded">
                                    Combo list
                                </a>
                                <a href="/combobuilder" class="block py-2 px-4  text-decoration-none text-light hover:bg-gray-800 hover:text-white rounded">
                                    Add Combo 
                                </a>
